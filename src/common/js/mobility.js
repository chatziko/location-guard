...
$(document).ready(function() {
	...
	// generic function that pass a user's file to a handler
	...
	// import a previously saved profile in json
	// previous profile is OVERWRITTEN, used only for testing
	...
	// generate a test profile from a geojson file with only points
